...
class MonoTest extends FreeSpec with Matchers with TableDrivenPropertyChecks {
  ...
  "Mono" - {
    ...
    ".and" - {
	  ...
	  "with rightGenerator and bi-function should combine the result of this mono and " +
		  "the result of monogenerated by the right generator and then combined using " +
		  "the bi-function" in {
		val mono = Mono.just(1)
